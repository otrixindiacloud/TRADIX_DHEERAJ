...
async function runDeliveryDeleteFix() {
  try {
    console.log("Running migration: Fix delivery delete cascade constraints");
    ...
    const migrationPath = path.join(__dirname, "one-time-scripts", "fix-delivery-delete-cascade.sql");
    ...
    console.log('✅ Delivery delete cascade fix completed successfully!');
    console.log('Fixed foreign key constraints:');
    console.log('  - delivery_items.delivery_id now has CASCADE DELETE');
    console.log('  - delivery_item.delivery_id now has CASCADE DELETE (if exists)');
    console.log('');
