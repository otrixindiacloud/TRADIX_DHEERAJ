          ...
          <div className="space-y-1">
            ...
            <Link href="/inventory">
              ...
              >
                ...
                <span className="font-medium">Material Receipts</span>
              </a>
            </Link>
              ...
              >
                ...
                <span className="font-medium"> Receipt Returns</span>
              </a>
            </Link>
            ...
            <Link href="/issue-return">
              <a
                className={cn(
                  "sidebar-item",
                  isActive("/issue-return")
                    ? "sidebar-item-active"
                    : "text-gray-700"
                )}
                data-testid="link-issue-return"
              >
                <FaUndo className="h-5 w-5 text-red-500" />
                <span className="font-medium">Issue Returns</span>
              </a>
            </Link>
