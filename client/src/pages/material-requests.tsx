...
export default function MaterialRequestsPage() {
  ...
  const uniqueDepartments = Array.from(new Set((Array.isArray(requests) ? requests : []).map((r: Requisition) => r.department))).filter(Boolean);
                          ...
                          <div className="space-y-2">
                            <Select onValueChange={field.onChange} value={field.value}>
                              ...
                              <SelectContent>
                                ...
                                <SelectItem 
                                  value="add-new" 
                                  onSelect={() => setShowAddDepartment(true)}
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-green-600">
                  {Number(selectedRequest.totalEstimatedCost).toLocaleString()}
                </p>
              </div>
              <div>
