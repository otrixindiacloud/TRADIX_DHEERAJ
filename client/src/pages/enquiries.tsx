  ...
  const columns: Column<any>[] = [
    ...
    },
    {
      ...
      render: (value: any, enquiry: any) => {
        ...
        const referralName = enquiry.referralName;
        const referralCustomer = enquiry.referralCustomer;
        
        if (referralName) {
          return (
            <div className="text-sm">
              <div className="font-medium text-gray-900">{referralName}</div>
              <div className="text-xs text-gray-500">Manual Entry</div>
            </div>
          );
        } else if (referralCustomer) {
          return (
            <div className="text-sm">
              <div className="font-medium text-gray-900">{referralCustomer.name}</div>
                ...
                <EnquiryForm 
                  onSuccess={(enquiry) => {
                    ...
                    if (enquiry?.id) {
                      ...
                      // Fallback: redirect to enquiries list
                      setTimeout(() => {
