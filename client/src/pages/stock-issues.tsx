...
export default function StockIssuesPage() {
  ...
  const [showStockIssueWizard, setShowStockIssueWizard] = useState(false);
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-gradient-to-r from-slate-50 to-red-50 rounded-xl p-6 border border-slate-200/50 shadow-sm">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-800 mb-1">Material Issues</h1>
              <p className="text-slate-600 text-base">Manage Material  issues for production, sales, and internal use</p>
          ...
          <Button 
            onClick={() => setShowStockIssueWizard(true)}
      ...
      {/* Stock Issue Wizard */}
      <StockIssueWizard
        open={showStockIssueWizard}
        onOpenChange={setShowStockIssueWizard}
        customers={customers}
        suppliers={suppliers}
        items={items}
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">All Material issues</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Material issued</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {filteredIssues.length} of {Array.isArray(stockIssues) ? stockIssues.length : 0} material  issues
          </CardDescription>
        </CardHeader>
        <CardContent>
          <DataTable
            ...
            columns={columns}
            isLoading={isLoading}
            emptyMessage="No Material issues found. Create your first Material issue to get started."
          />
      </CardContent>
    </Card>
          ...
          {selectedIssue && (
            <EditStockIssueForm
              ...
              onSuccess={() => {
                ...
                queryClient.invalidateQueries({ queryKey: ["stock-issues"] });
                toast({ title: "Success", description: "Material issue updated successfully" });
              }}
            />
          )}
        </DialogContent>
      ...
      <Dialog open={showDetailsDialog} onOpenChange={setShowDetailsDialog}>
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            <DialogTitle>Material Issue Details</DialogTitle>
            <DialogDescription>
...
function EditStockIssueForm({ issue, items, onClose, onSuccess }: { issue: any, items: any[], onClose: () => void, onSuccess: () => void }) {
  ...
  const { mutate, isPending } = useMutation({
    ...
    onError: (error: any) => {
      toast({ title: "Error", description: error.message || "Failed to update Material issue", variant: "destructive" });
    },
  });
