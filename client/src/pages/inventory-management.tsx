...
function GoodsReceiptsTab() {
  ...
  const handleCreateReceipt = async () => {
    if (!selectedLpoId || !formData.receiptDate || !formData.receivedBy) {
      toast({
        title: "Error",
        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4 mt-4">
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-1">Receipt number will be auto-generated when you create the receipt</p>
            </div>
