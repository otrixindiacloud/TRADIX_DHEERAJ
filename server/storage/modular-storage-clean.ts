...
import { issueReturnStorage } from './issue-returns-storage.js';
...
export class ModularStorage extends BaseStorage {
  ...
  private issueReturnStorage: any;
  ...
  this.supplierLpoStorage = new SupplierLpoStorage();
    ...
    this.issueReturnStorage = issueReturnStorage;
  ...
  async updateFinancialTotals(salesOrderId: string): Promise<void> {
    return this.salesOrderStorage.updateFinancialTotals(salesOrderId);
  }

  async recalculateAllFinancialTotals(): Promise<void> {
    return this.salesOrderStorage.recalculateAllFinancialTotals();
  }
  ...
  async getInventoryLevelByItem(itemId: string, location?: string) {
    return this.inventoryStorage.getInventoryLevelByItem(itemId, location);
  }

  async createInventoryLevel(inventory: any) {
    return this.inventoryStorage.createInventoryLevel(inventory);
  }

  async updateInventoryLevel(id: string, inventory: any) {
    return this.inventoryStorage.updateInventoryLevel(id, inventory);
  }

  async deleteInventoryLevel(id: string) {
    return this.inventoryStorage.deleteInventoryLevel(id);
  }

  async adjustInventoryQuantity(itemId: string, quantityChange: number, location?: string, reason?: string) {
    return this.inventoryStorage.adjustInventoryQuantity(itemId, quantityChange, location, reason);
  }

  async bulkCreateInventoryItems(items: any[]) {
    return this.inventoryStorage.bulkCreateInventoryItems(items);
  }
  ...
  async getInvoiceWithCompleteDetails(invoiceNumber: string) {
    return this.invoiceStorage.getInvoiceWithCompleteDetails(invoiceNumber);
  }
  ...
  async generateInvoiceFromDelivery(deliveryId: string, invoiceType?: string, userId?: string, selectedDeliveryItemIds?: string[]) {
    return this.invoiceStorage.generateInvoiceFromDelivery(deliveryId, invoiceType, userId, selectedDeliveryItemIds);
  }
  ...
  async updateStockMovement(id: string, movement: any) {
  ...
  // Issue Returns methods
  async getIssueReturns() {
    return this.issueReturnStorage.getIssueReturns();
  }

  async getIssueReturnById(id: string) {
    return this.issueReturnStorage.getIssueReturnById(id);
  }

  async createIssueReturn(data: any) {
    return this.issueReturnStorage.createIssueReturn(data);
  }

  async updateIssueReturn(id: string, data: any) {
    return this.issueReturnStorage.updateIssueReturn(id, data);
  }

  async deleteIssueReturn(id: string) {
    return this.issueReturnStorage.deleteIssueReturn(id);
  }

  async getStockIssueById(id: string) {
    return this.issueReturnStorage.getStockIssueById(id);
  }
