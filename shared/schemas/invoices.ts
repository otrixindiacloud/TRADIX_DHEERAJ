...
export const invoices = pgTable("invoices", {
  ...
  deliveryId: uuid("delivery_id").references(() => deliveries.id, { onDelete: "set null" }), // References deliveries.id
  ...
  generatedFromDeliveryId: uuid("generated_from_delivery_id").references(() => deliveries.id, { onDelete: "set null" }), // References deliveries.id
