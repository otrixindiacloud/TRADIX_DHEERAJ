import { pgTable, uuid, varchar, timestamp, text, decimal, boolean, integer, jsonb, createInsertSchema, sql } from "./common";
...
export const salesOrders = pgTable("sales_orders", {
  ...
  quotationId: uuid("quotation_id").references(() => quotations.id, { onDelete: "set null" }), // Will reference quotations.id
