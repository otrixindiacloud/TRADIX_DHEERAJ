...
export const goodsReceiptHeaders = pgTable("goods_receipt_headers", {
  ...
  lpoValue: decimal("lpo_value", { precision: 12, scale: 2 }), // LPO value for reference
  lpoCurrency: varchar("lpo_currency", { length: 10 }).default("BHD"), // LPO currency
...
export const insertGoodsReceiptHeaderSchema = createInsertSchema(goodsReceiptHeaders, {
  ...
  receiptNumber: z.string().optional(), // Make receiptNumber optional since it will be auto-generated
}).omit({ 
  id: true, 
  createdAt: true, 
  updatedAt: true 
