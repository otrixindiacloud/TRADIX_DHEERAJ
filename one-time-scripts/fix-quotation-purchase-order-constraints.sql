-- Fix purchase order foreign key constraints to allow quotation deletion
-- This migration fixes the 500 error when deleting quotations

-- Drop existing foreign key constraint on purchase_orders table
